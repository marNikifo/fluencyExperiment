...
async function experimentInit() {
  ...
  tabExitMessage = new visual.TextStim({
    win: psychoJS.window,
    name: 'tabExitMessage',
    text: 'Please leave the browser window/tab open for 30 seconds before closing it so that the data will be saved! You can exit this experiment by pressing the TAB KEY. ',
    font: 'Open Sans',
    units: undefined, 
